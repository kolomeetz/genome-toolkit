...
Genome Toolkit is a set of [Claude Code](https://claude.ai/claude-code) skills and Python scripts that import DTC genome data (23andMe, AncestryDNA, MyHeritage, Genotek, Nebula, or any VCF), build a structured [Obsidian](https://obsidian.md) knowledge vault, and generate clinically useful outputs like drug safety cards and prescriber summaries.
